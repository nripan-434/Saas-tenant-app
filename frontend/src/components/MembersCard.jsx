  ...
  return (
...

        {
            ...
            members?.map(x=>{
                ...
                <h1>status</h1>
                <div>
                <button onClick={()=>{dispatch(removemember({userId:x._id,orgId}))}} className='cursor-pointer absolute bottom-2 right-4 bg-red-700 text-white rounded-xl  p-2'>remove</button>
